...
const products = [
  ...
  {
    id: 4,
    name: "Special Elaichi Shrikhand",
    price: 249,
  ...
  return (
    <div className="min-h-screen bg-[#f5f1ea] px-6 py-10">
      <h2 className="mb-10 text-left text-3xl font-bold text-[#1f1f1f]">
        Sweets & Savouries ({products.length})
      </h2>
              ...
              <div className="mt-4">
                ...
                {!isOpen ? (
                  <button
                    ...
                    className="mt-4 flex w-full items-center justify-center rounded-full bg-[#5c5f2a] py-3 text-sm font-semibold text-white transition hover:bg-[#4a4d20]"
                  >
                    Add to Cart
                  </button>
                ) : (

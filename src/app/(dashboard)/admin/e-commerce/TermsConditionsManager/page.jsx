// src/components/admin/TermsConditionsManager.jsx
"use client";
...
export default function TermsConditionsManager() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await fetch(`/api/terms-conditions/${editingSection._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          section: formData.section,
        ...
        <form onSubmit={editingSection ? handleUpdate : handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              placeholder="e.g., Use of Website, Orders, Pricing & Payment"

    ...
    try {
      ...
      if (res.data && res.data.success) {
        ...
        if (mappedProducts.length === 0) {
          ...
          toast.success(`Showing products from ${res.data.nearestWarehouse.name} (${res.data.nearestWarehouse.distance})`);
        }
      } else {
        await fetchAllProducts();
      }
              ...
              <div className="mx-auto w-full max-w-[700px]">
                ...
                {!isAuthenticated ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">
                      {usingLocation 
                        ? `No products available at ${nearestWarehouse?.name || 'nearest warehouse'}. Try changing your location.`
